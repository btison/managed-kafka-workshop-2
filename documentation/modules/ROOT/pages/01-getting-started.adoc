...
. Click *Manage access*, use the *Account* drop-down menu to select *All accounts*, and click *Next*.
...
+
* *Topic name*: Enter a unique topic name. For this workshop, the name of the topic should be `stocks`.
